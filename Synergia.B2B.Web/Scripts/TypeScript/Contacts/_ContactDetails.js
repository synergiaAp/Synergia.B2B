var ContactDetails = /** @class */ (function () {
    ...
    ContactDetails.prototype.init = function () {
        this.assignEvents();
        this.initAutocomplete();
    };
    ContactDetails.prototype.assignEvents = function () {
    ...
    ContactDetails.prototype.initAutocomplete = function () {
        ...
        $("#OffersCompanyName").blur(function () {
            $("#OffersCompanyName").val($("#OffersCompanyName").attr('data-tempValue')).trigger('change');
        });
    };
    ContactDetails.prototype.edit = function (installationObjectId) {
        $.ajax({
    ...
    ContactDetails.prototype.save = function () {
...
//# sourceMappingURL=_ContactDetails.js.map