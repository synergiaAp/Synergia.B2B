var HoodOrdersList = /** @class */ (function () {
    function HoodOrdersList() {
    }
    HoodOrdersList.prototype.init = function () {
        var _this = this;
        $('#modalHoodOrderDetails').on('hide.bs.modal', function () {
            setTimeout(function () {
                _this.loadList();
            }, 100);
        });
        $('#HoodOrderTypeFilter').change(function () {
            _this.loadList();
        });
        this.loadList();
    };
    HoodOrdersList.prototype.loadList = function () {
        if (!this.list) {
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row, meta) {
                            if (row.OrderPdfGeneratedFileName != null) {
                                var result = '<a href="/Files/GetCRMFile/' + row.OrderPdfGeneratedFileName + '/' + row.OrderPdfOriginalFileName.replaceAll('/', '_')
    ...
    return HoodOrdersList;
}());
var hoodOrdersList = new HoodOrdersList();
$(document).ready(function () {
    hoodOrdersList.init();
});
//# sourceMappingURL=HoodOrdersList.js.map