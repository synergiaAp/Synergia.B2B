var LayoutMain = /** @class */ (function () {
    function LayoutMain() {
    }
    LayoutMain.prototype.init = function () {
        ...
        $('.weekpicker').on('dp.change', function () {
            if ($(this).attr('data-canChange') == '1') {
                ...
                var startWeekDate = moment(value).startOf('week');
                var endWeekDate = moment(startWeekDate).add('days', 7);
            ...
            var value = $(this).siblings('.weekpickerHidden').val() != ''
